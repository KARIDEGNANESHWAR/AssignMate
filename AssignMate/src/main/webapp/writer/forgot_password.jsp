...
<html>
<head>
    <title>Forgot Password - Writer</title>
    <link rel="stylesheet" href="../css/login.css">
</head>
<body class="bg-img">
<div class="overlay">
    <div class="login-container">
        <h2 class="login-title">Forgot Password - Writer</h2>
        ...
        <form action="../WriterForgotPasswordServlet" method="post" class="form-grid">
        ...
        <p class="bottom-link">
            Remembered your password? <a href="writer_login.jsp">Go back to login</a>
        </p>
    </div>
</div>
</body>
